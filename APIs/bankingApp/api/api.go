...
import (
	...
	"github.com/RSGuelfi/golang/bankingApp/transactions"
	"github.com/RSGuelfi/golang/bankingApp/useraccounts"
	"github.com/RSGuelfi/golang/bankingApp/users"
...
func StartApi() {
	...
	router.HandleFunc("/login", login).Methods("POST") // Token is JWT:""

	router.HandleFunc("/register", register).Methods("POST") // Register new user

	router.HandleFunc("/transaction", transaction).Methods("POST") // Needs token

	router.HandleFunc("/transactions/{userID}", getMyTransactions).Methods("GET") // Needs token

	router.HandleFunc("/user/{id}", getUser).Methods("GET") // Needs token
